...
add(0, 'label', Point(11, -12.4, 0), text='Kräfteplan — force diagram')
add(0, 'label', Point(11, -13.8, 0), text='to scale · 1 unit ≙ 10 kN  (sheet: 1 cm ≙ 20 kN)')

# step 1 — What is given
add(1, 'point', Point(-18, -4, 0), color=Color.from_hex("#ffffff"), width=0.3256)
add(1, 'label', Point(-19.5, -4.9, 0), text='A')
add(1, 'segment', Line((-19.2, -4.55, 0), (-19.9425, -3.80754, 0)), color=Color.from_hex("#aaaaaa"), width=0.033264)
add(1, 'segment', Line((-18.4, -4.55, 0), (-19.1425, -3.80754, 0)), color=Color.from_hex("#aaaaaa"), width=0.033264)
add(1, 'segment', Line((-17.6, -4.55, 0), (-18.3425, -3.80754, 0)), color=Color.from_hex("#aaaaaa"), width=0.033264)
add(1, 'segment', Line((-16.8, -4.55, 0), (-17.5425, -3.80754, 0)), color=Color.from_hex("#aaaaaa"), width=0.033264)
add(1, 'segment', Line((-16, -4.55, 0), (-16.7425, -3.80754, 0)), color=Color.from_hex("#aaaaaa"), width=0.033264)
add(1, 'point', Point(0, -4, 0), color=Color.from_hex("#ffffff"), width=0.3256)
add(1, 'label', Point(1.5, -4.9, 0), text='B')
add(1, 'segment', Line((-1.2, -4.55, 0), (-1.94246, -3.80754, 0)), color=Color.from_hex("#aaaaaa"), width=0.033264)
add(1, 'segment', Line((-0.4, -4.55, 0), (-1.14246, -3.80754, 0)), color=Color.from_hex("#aaaaaa"), width=0.033264)
add(1, 'segment', Line((0.4, -4.55, 0), (-0.342462, -3.80754, 0)), color=Color.from_hex("#aaaaaa"), width=0.033264)
add(1, 'segment', Line((1.2, -4.55, 0), (0.457538, -3.80754, 0)), color=Color.from_hex("#aaaaaa"), width=0.033264)
add(1, 'segment', Line((2, -4.55, 0), (1.25754, -3.80754, 0)), color=Color.from_hex("#aaaaaa"), width=0.033264)
...
add(5, 'arrow', Line((10.671, 0, 0), (18.2416, 5.67792, 0)), color=Color.from_hex("#3f9c20"), width=0.086803, head=(0.280685, 0.120384))
...
add(5, 'arrow', Line((18.2416, -5.67792, 0), (10.671, 0, 0)), color=Color.from_hex("#3f9c20"), width=0.086803, head=(0.280685, 0.120384))
