...
add(1, 'arrow', Line((100.949, 45.049, 0), (98.6546, 33.5762, 0)), color=Color.from_hex("#3f9c20"), width=0.36, head=(1.152, 0.432))
...
add(15, 'arrow', Line((97.4622, 35.3572, 0), (73.6089, 54.5157, 0)), color=Color.from_hex("#3f9c20"), width=0.36, head=(1.152, 0.432))
add(15, 'arrow', Line((73.3615, 51.6923, 0), (96.4474, 64.3606, 0)), color=Color.from_hex("#3f9c20"), width=0.36, head=(1.152, 0.432))
