...
add(6, 'arrow', Line((19.8975, 4.40587, 0), (19.8975, 3.05685, 0)), color=Color.from_hex("#3f9c20"), width=0.072, head=(0.3024, 0.1296))
...
add(13, 'arrow', Line((26.567, 8.77401, 0), (19.9563, 10.0961, 0)), color=Color.from_hex("#3f9c20"), width=0.0936, head=(0.36, 0.1584))
...
add(13, 'arrow', Line((31.4294, -2.66912, 0), (26.7855, 8.59418, 0)), color=Color.from_hex("#3f9c20"), width=0.0936, head=(0.36, 0.1584))
...
add(13, 'arrow', Line((19.7593, 2.79056, 0), (31.0138, -3.04976, 0)), color=Color.from_hex("#3f9c20"), width=0.0936, head=(0.36, 0.1584))
