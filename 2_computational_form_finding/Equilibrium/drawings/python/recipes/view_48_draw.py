...
add(4, 'arrow', Line((19.1262, 1.29854, 0), (19.1262, -6.70146, 0)), color=Color.from_hex("#3f9c20"), width=0.144, head=(0.396, 0.18))
...
add(10, 'arrow', Line((19.6262, -6.70146, 0), (19.6262, -2.70146, 0)), color=Color.from_hex("#3f9c20"), width=0.1224, head=(0.3456, 0.1512))
add(10, 'arrow', Line((19.6262, -2.70146, 0), (19.6262, 1.29854, 0)), color=Color.from_hex("#3f9c20"), width=0.1224, head=(0.3456, 0.1512))
