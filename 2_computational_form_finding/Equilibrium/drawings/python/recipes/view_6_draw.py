...
add(1, 'arrow', Line((101.934, 46.3399, 0), (99.6391, 34.8671, 0)), color=Color.from_hex("#3f9c20"), width=0.36, head=(1.152, 0.432))
...
add(16, 'arrow', Line((98.4113, 36.6757, 0), (73.1718, 55.8771, 0)), color=Color.from_hex("#3f9c20"), width=0.36, head=(1.152, 0.432))
add(16, 'arrow', Line((72.9213, 53.0056, 0), (97.3934, 65.631, 0)), color=Color.from_hex("#3f9c20"), width=0.36, head=(1.152, 0.432))
