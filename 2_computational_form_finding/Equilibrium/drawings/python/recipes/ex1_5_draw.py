...
add(1, 'segment', Line((-23, -4, 0), (-23.6718, -4.67175, 0)), color=Color.from_hex("#aaaaaa"), width=0.031752)
add(1, 'segment', Line((-22, -4, 0), (-22.6718, -4.67175, 0)), color=Color.from_hex("#aaaaaa"), width=0.031752)
add(1, 'segment', Line((-21, -4, 0), (-21.6718, -4.67175, 0)), color=Color.from_hex("#aaaaaa"), width=0.031752)
add(1, 'segment', Line((-20, -4, 0), (-20.6718, -4.67175, 0)), color=Color.from_hex("#aaaaaa"), width=0.031752)
add(1, 'segment', Line((-19, -4, 0), (-19.6718, -4.67175, 0)), color=Color.from_hex("#aaaaaa"), width=0.031752)
add(1, 'segment', Line((-18, -4, 0), (-18.6718, -4.67175, 0)), color=Color.from_hex("#aaaaaa"), width=0.031752)
add(1, 'segment', Line((-17, -4, 0), (-17.6718, -4.67175, 0)), color=Color.from_hex("#aaaaaa"), width=0.031752)
add(1, 'segment', Line((-16, -4, 0), (-16.6718, -4.67175, 0)), color=Color.from_hex("#aaaaaa"), width=0.031752)
add(1, 'segment', Line((-15, -4, 0), (-15.6718, -4.67175, 0)), color=Color.from_hex("#aaaaaa"), width=0.031752)
add(1, 'segment', Line((-14, -4, 0), (-14.6718, -4.67175, 0)), color=Color.from_hex("#aaaaaa"), width=0.031752)
add(1, 'segment', Line((-13, -4, 0), (-13.6718, -4.67175, 0)), color=Color.from_hex("#aaaaaa"), width=0.031752)
add(1, 'segment', Line((-12, -4, 0), (-12.6718, -4.67175, 0)), color=Color.from_hex("#aaaaaa"), width=0.031752)
add(1, 'segment', Line((-11, -4, 0), (-11.6718, -4.67175, 0)), color=Color.from_hex("#aaaaaa"), width=0.031752)
add(1, 'segment', Line((-10, -4, 0), (-10.6718, -4.67175, 0)), color=Color.from_hex("#aaaaaa"), width=0.031752)
add(1, 'segment', Line((-9, -4, 0), (-9.67175, -4.67175, 0)), color=Color.from_hex("#aaaaaa"), width=0.031752)
add(1, 'segment', Line((-8, -4, 0), (-8.67175, -4.67175, 0)), color=Color.from_hex("#aaaaaa"), width=0.031752)
add(1, 'segment', Line((-7, -4, 0), (-7.67175, -4.67175, 0)), color=Color.from_hex("#aaaaaa"), width=0.031752)
add(1, 'segment', Line((-6, -4, 0), (-6.67175, -4.67175, 0)), color=Color.from_hex("#aaaaaa"), width=0.031752)
add(1, 'segment', Line((-5, -4, 0), (-5.67175, -4.67175, 0)), color=Color.from_hex("#aaaaaa"), width=0.031752)
add(1, 'segment', Line((-4, -4, 0), (-4.67175, -4.67175, 0)), color=Color.from_hex("#aaaaaa"), width=0.031752)
add(1, 'segment', Line((-3, -4, 0), (-3.67175, -4.67175, 0)), color=Color.from_hex("#aaaaaa"), width=0.031752)
add(1, 'segment', Line((-2, -4, 0), (-2.67175, -4.67175, 0)), color=Color.from_hex("#aaaaaa"), width=0.031752)
add(1, 'segment', Line((-1, -4, 0), (-1.67175, -4.67175, 0)), color=Color.from_hex("#aaaaaa"), width=0.031752)
add(1, 'segment', Line((0, -4, 0), (-0.671751, -4.67175, 0)), color=Color.from_hex("#aaaaaa"), width=0.031752)
add(1, 'segment', Line((1, -4, 0), (0.328249, -4.67175, 0)), color=Color.from_hex("#aaaaaa"), width=0.031752)
add(1, 'segment', Line((2, -4, 0), (1.32825, -4.67175, 0)), color=Color.from_hex("#aaaaaa"), width=0.031752)
