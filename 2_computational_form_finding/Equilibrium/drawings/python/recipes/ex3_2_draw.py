...
add(1, 'label', Point(4.685, 3.75543, 0), color=Color.from_hex("#3f9c20"), text='F_d1')
...
add(1, 'label', Point(9.788, 1.79893, 0), color=Color.from_hex("#3f9c20"), text='F_d2')
...
add(1, 'label', Point(17.438, 1.23757, 0), color=Color.from_hex("#3f9c20"), text='F_d3')
...
add(1, 'label', Point(27.644, 5.08132, 0), color=Color.from_hex("#3f9c20"), text='F_d4')
...
add(2, 'label', Point(-12.1, -10.4286, 0), color=Color.from_hex("#3f9c20"), text='F_d1')
add(2, 'arrow', Line((-14, -11.8571, 0), (-14, -17.5714, 0)), color=Color.from_hex("#3f9c20"), width=0.186048, head=(0.641376, 0.247738))
add(2, 'label', Point(-12.1, -14.7143, 0), color=Color.from_hex("#3f9c20"), text='F_d2')
add(2, 'arrow', Line((-14, -17.5714, 0), (-14, -23.2857, 0)), color=Color.from_hex("#3f9c20"), width=0.186048, head=(0.641376, 0.247738))
add(2, 'label', Point(-12.1, -20.4286, 0), color=Color.from_hex("#3f9c20"), text='F_d3')
add(2, 'arrow', Line((-14, -23.2857, 0), (-14, -26.1429, 0)), color=Color.from_hex("#3f9c20"), width=0.186048, head=(0.641376, 0.247738))
add(2, 'label', Point(-12.1, -24.7143, 0), color=Color.from_hex("#3f9c20"), text='F_d4')

# step 3 — The auxiliary construction
add(3, 'point', Point(-22, -17.5714, 0), color=Color.from_hex("#ffffff"), width=0.35224)
add(3, 'label', Point(-23.3, -16.8714, 0), text='o′')
add(3, 'segment', Line((-22, -17.5714, 0), (-14, -9, 0)), color=Color.from_hex("#aaaaaa"), width=0.072461)
add(3, 'segment', Line((-22, -17.5714, 0), (-14, -11.8571, 0)), color=Color.from_hex("#aaaaaa"), width=0.072461)
add(3, 'segment', Line((-22, -17.5714, 0), (-14, -17.5714, 0)), color=Color.from_hex("#aaaaaa"), width=0.072461)
add(3, 'segment', Line((-22, -17.5714, 0), (-14, -23.2857, 0)), color=Color.from_hex("#aaaaaa"), width=0.072461)
add(3, 'segment', Line((-22, -17.5714, 0), (-14, -26.1429, 0)), color=Color.from_hex("#aaaaaa"), width=0.072461)
add(3, 'segment', Line((3.085, -1.5, 0), (8.188, 2.145, 0)), color=Color.from_hex("#aaaaaa"), width=0.113587)
add(3, 'segment', Line((8.188, 2.145, 0), (15.838, 2.145, 0)), color=Color.from_hex("#aaaaaa"), width=0.113587)
add(3, 'segment', Line((15.838, 2.145, 0), (26.044, -5.145, 0)), color=Color.from_hex("#aaaaaa"), width=0.113587)
add(3, 'polyline', Polyline([(12.8635, 8.97696, 0), (3.085, -1.5, 0)]), color=Color.from_hex("#aaaaaa"), dash=0.4012)
add(3, 'polyline', Polyline([(26.044, -5.145, 0), (12.8635, 8.97696, 0)]), color=Color.from_hex("#aaaaaa"), dash=0.4012)
...
add(8, 'polygon', Polygon([(-2.24701, 2.74225, 0), (-1.75299, 3.25775, 0), (3.33201, -1.61539, 0), (2.83799, -2.13089, 0)]), color=Color.from_hex("#f0bcdb"))
add(8, 'polygon', Polygon([(2.91402, -2.13089, 0), (3.25598, -1.61539, 0), (8.35898, -5.00047, 0), (8.01702, -5.51596, 0)]), color=Color.from_hex("#f0bcdb"))
add(8, 'polygon', Polygon([(8.16909, -5.51596, 0), (8.20691, -5.00047, 0), (15.8569, -5.56182, 0), (15.8191, -6.07732, 0)]), color=Color.from_hex("#f0bcdb"))
add(8, 'polygon', Polygon([(15.9712, -6.07732, 0), (15.7048, -5.56182, 0), (25.9108, -0.289498, 0), (26.1772, -0.804997, 0)]), color=Color.from_hex("#f0bcdb"))
add(8, 'polygon', Polygon([(26.2532, -0.804997, 0), (25.8348, -0.289498, 0), (36.0498, 8.00075, 0), (36.4682, 7.48525, 0)]), color=Color.from_hex("#f0bcdb"))
