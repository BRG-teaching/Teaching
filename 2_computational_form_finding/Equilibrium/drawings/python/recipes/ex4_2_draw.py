...
add(1, 'segment', Line((-20.08, -3.5, 0), (-20.7518, -2.82825, 0)), color=Color.from_hex("#aaaaaa"), width=0.034776)
add(1, 'segment', Line((-19.36, -3.5, 0), (-20.0318, -2.82825, 0)), color=Color.from_hex("#aaaaaa"), width=0.034776)
add(1, 'segment', Line((-18.64, -3.5, 0), (-19.3118, -2.82825, 0)), color=Color.from_hex("#aaaaaa"), width=0.034776)
add(1, 'segment', Line((-17.92, -3.5, 0), (-18.5918, -2.82825, 0)), color=Color.from_hex("#aaaaaa"), width=0.034776)
add(1, 'segment', Line((-17.2, -3.5, 0), (-17.8718, -2.82825, 0)), color=Color.from_hex("#aaaaaa"), width=0.034776)
...
add(1, 'segment', Line((-12.16, -3.5, 0), (-12.8318, -2.82825, 0)), color=Color.from_hex("#aaaaaa"), width=0.034776)
add(1, 'segment', Line((-11.44, -3.5, 0), (-12.1118, -2.82825, 0)), color=Color.from_hex("#aaaaaa"), width=0.034776)
add(1, 'segment', Line((-10.72, -3.5, 0), (-11.3918, -2.82825, 0)), color=Color.from_hex("#aaaaaa"), width=0.034776)
add(1, 'segment', Line((-10, -3.5, 0), (-10.6718, -2.82825, 0)), color=Color.from_hex("#aaaaaa"), width=0.034776)
add(1, 'segment', Line((-9.28, -3.5, 0), (-9.95175, -2.82825, 0)), color=Color.from_hex("#aaaaaa"), width=0.034776)
...
add(1, 'segment', Line((-4.24, -3.5, 0), (-4.91175, -2.82825, 0)), color=Color.from_hex("#aaaaaa"), width=0.034776)
add(1, 'segment', Line((-3.52, -3.5, 0), (-4.19175, -2.82825, 0)), color=Color.from_hex("#aaaaaa"), width=0.034776)
add(1, 'segment', Line((-2.8, -3.5, 0), (-3.47175, -2.82825, 0)), color=Color.from_hex("#aaaaaa"), width=0.034776)
add(1, 'segment', Line((-2.08, -3.5, 0), (-2.75175, -2.82825, 0)), color=Color.from_hex("#aaaaaa"), width=0.034776)
add(1, 'segment', Line((-1.36, -3.5, 0), (-2.03175, -2.82825, 0)), color=Color.from_hex("#aaaaaa"), width=0.034776)
