...
add(0, 'label', Point(-14, 1, 0), text='Kräfteplan — this page says 1 cm ≙ 20 kN')
...
add(1, 'polygon', Polygon([(17.1485, -1.6, 0), (17.1485, 2.1485, 0), (16.8485, 2.1485, 0), (16.8485, -1.6, 0)]), color=Color.from_hex("#111111"), opacity=0.9)
add(1, 'polygon', Polygon([(18.2735, 0.27425, 0), (17.6135, 0.53, 0), (17.6135, 0.0185, 0)]), color=Color.from_hex("#111111"))
add(1, 'label', Point(16.286, 0.27425, 0), text='A')
add(1, 'polygon', Polygon([(19.247, 7.09625, 0), (22.9962, 7.09625, 0), (22.9962, 7.39625, 0), (19.247, 7.39625, 0)]), color=Color.from_hex("#111111"), opacity=0.9)
add(1, 'polygon', Polygon([(21.1216, 5.97125, 0), (21.3774, 6.63125, 0), (20.8659, 6.63125, 0)]), color=Color.from_hex("#111111"))
add(1, 'label', Point(21.1216, 6.53375, 0), text='B')
add(1, 'polygon', Polygon([(22.9962, -1.6, 0), (22.9962, 2.1485, 0), (22.6962, 2.1485, 0), (22.6962, -1.6, 0)]), color=Color.from_hex("#111111"), opacity=0.9)
add(1, 'polygon', Polygon([(21.5712, 0.27425, 0), (22.2312, 0.0185, 0), (22.2312, 0.53, 0)]), color=Color.from_hex("#111111"))
add(1, 'label', Point(23.5587, 0.27425, 0), text='C')

# step 2 — The axes, and whether it stands up
add(2, 'polyline', Polyline([(16.9985, -3.25, 0), (16.9985, 9.04625, 0)]), color=Color.from_hex("#aaaaaa"), dash=0.3304)
add(2, 'polyline', Polyline([(9.35, 7.24625, 0), (24.6462, 7.24625, 0)]), color=Color.from_hex("#aaaaaa"), dash=0.3304)
add(2, 'polyline', Polyline([(22.8463, -3.25, 0), (22.8463, 9.04625, 0)]), color=Color.from_hex("#aaaaaa"), dash=0.3304)
add(2, 'point', Point(16.9985, 7.24625, 0), color=Color.from_hex("#ffffff"), width=0.3108)
add(2, 'point', Point(22.8463, 7.24625, 0), color=Color.from_hex("#ffffff"), width=0.3108)
add(2, 'label', Point(16.9981, -5, 0), color=Color.from_hex("#aaaaaa"), text='2 distinct axis intersections → properly braced')

# step 3 — The load
add(3, 'polyline', Polyline([(8.75, 2.89775, 0), (25.2462, 2.89775, 0)]), color=Color.from_hex("#aaaaaa"), dash=0.3304)
add(3, 'arrow', Line((6, 2.89775, 0), (11, 2.89775, 0)), color=Color.from_hex("#3f9c20"), width=0.153216, head=(0.528192, 0.204019))
add(3, 'label', Point(8.5, 4.19775, 0), color=Color.from_hex("#3f9c20"), text='F = 100.0 kN')
add(3, 'segment', Line((9.95, 2.89775, 0), (9.95, 7.24625, 0)), color=Color.from_hex("#aaaaaa"), width=0.042336)
add(3, 'label', Point(6.95, 5.072, 0), color=Color.from_hex("#aaaaaa"), text='5.798 m')

# step 4 — One force, then one couple
add(4, 'arrow', Line((15.7235, -3.44385, 0), (15.7235, 0.27425, 0)), color=Color.from_hex("#3f9c20"), width=0.110477, head=(0.357235, 0.153216))
add(4, 'label', Point(12.5235, -2.4848, 0), color=Color.from_hex("#3f9c20"), text='A = 74.36 kN')
add(4, 'arrow', Line((26.1216, 8.52125, 0), (21.1216, 8.52125, 0)), color=Color.from_hex("#3f9c20"), width=0.110477, head=(0.357235, 0.153216))
add(4, 'label', Point(23.6216, 9.82125, 0), color=Color.from_hex("#3f9c20"), text='B = 100.00 kN')
add(4, 'arrow', Line((24.1212, 3.99235, 0), (24.1212, 0.27425, 0)), color=Color.from_hex("#3f9c20"), width=0.110477, head=(0.357235, 0.153216))
add(4, 'label', Point(27.3212, 2.1333, 0), color=Color.from_hex("#3f9c20"), text='C = 74.36 kN')

# step 5 — The force diagram is a rectangle
add(5, 'arrow', Line((-17.75, -4.98857, 0), (-10.25, -4.98857, 0)), color=Color.from_hex("#3f9c20"), width=0.110477, head=(0.357235, 0.153216))
add(5, 'label', Point(-14, -3.48857, 0), color=Color.from_hex("#3f9c20"), text='F = 100.00')
add(5, 'arrow', Line((-10.25, -4.98857, 0), (-10.25, 0.588573, 0)), color=Color.from_hex("#3f9c20"), width=0.110477, head=(0.357235, 0.153216))
add(5, 'label', Point(-7.35, -2.2, 0), color=Color.from_hex("#3f9c20"), text='A = 74.36')
add(5, 'arrow', Line((-10.25, 0.588573, 0), (-17.75, 0.588573, 0)), color=Color.from_hex("#3f9c20"), width=0.110477, head=(0.357235, 0.153216))
add(5, 'label', Point(-14, -0.911427, 0), color=Color.from_hex("#3f9c20"), text='B = 100.00')
add(5, 'arrow', Line((-17.75, 0.588573, 0), (-17.75, -4.98857, 0)), color=Color.from_hex("#3f9c20"), width=0.110477, head=(0.357235, 0.153216))
add(5, 'label', Point(-20.65, -2.2, 0), color=Color.from_hex("#3f9c20"), text='C = 74.36')
add(5, 'label', Point(-14, -8.18857, 0), color=Color.from_hex("#aaaaaa"), text='it closes as a rectangle — and would close just as well if A and C were wrong')
