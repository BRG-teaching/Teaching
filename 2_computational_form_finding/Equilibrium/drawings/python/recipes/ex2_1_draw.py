...
add(2, 'arrow', Line((27, -3, 0), (27, -15.5, 0)), color=Color.from_hex("#3f9c20"), width=0.19152, head=(0.66024, 0.255024))
...
add(2, 'arrow', Line((27, -27, 0), (27, -39.5, 0)), color=Color.from_hex("#3f9c20"), width=0.19152, head=(0.66024, 0.255024))
...
add(4, 'arrow', Line((27.4102, -15.008, 0), (20.5037, -9.25, 0)), color=Color.from_hex("#3f9c20"), width=0.138096, head=(0.446544, 0.19152))
add(4, 'arrow', Line((-6.5, -2, 0), (-1.2195, 2.40249, 0)), color=Color.from_hex("#3f9c20"), width=0.138096, head=(0.446544, 0.19152))
add(4, 'arrow', Line((20.5037, -9.25, 0), (27.4102, -3.49195, 0)), color=Color.from_hex("#3f9c20"), width=0.138096, head=(0.446544, 0.19152))
...
add(5, 'arrow', Line((26.7538, -40.0913, 0), (11.9929, -33.9438, 0)), color=Color.from_hex("#3f9c20"), width=0.138096, head=(0.446544, 0.19152))
add(5, 'arrow', Line((-6.5, -26, 0), (-0.153404, -23.3568, 0)), color=Color.from_hex("#3f9c20"), width=0.138096, head=(0.446544, 0.19152))
add(5, 'arrow', Line((11.9929, -33.9438, 0), (27.2462, -27.5913, 0)), color=Color.from_hex("#3f9c20"), width=0.138096, head=(0.446544, 0.19152))
