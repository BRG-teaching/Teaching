...
add(0, 'label', Point(-14.6036, 1.2, 0), text='Subsystem B — Ansicht 1:200, 24.99 m long, 2.999 m deep')
add(0, 'label', Point(7.84811, 12.5975, 0), text='Grundriss 1:500')
add(0, 'label', Point(22, 13.4, 0), text='Kräfteplan — 1 unit ≙ 33.3 kN (sheet: 1 cm ≙ 50 kN)')
...
add(1, 'segment', Line((-24.6, -4.6, 0), (-4.6072, -4.6, 0)), color=Color.from_hex("#111111"), width=0.093542)
add(1, 'segment', Line((-4.6072, -4.6, 0), (-4.6072, -2.2008, 0)), color=Color.from_hex("#111111"), width=0.093542)
add(1, 'segment', Line((-4.6072, -2.2008, 0), (-24.6, -2.2008, 0)), color=Color.from_hex("#111111"), width=0.093542)
add(1, 'segment', Line((-24.6, -2.2008, 0), (-24.6, -4.6, 0)), color=Color.from_hex("#111111"), width=0.093542)
add(1, 'point', Point(-24.4, -4.6, 0), color=Color.from_hex("#ffffff"), width=0.4144)
add(1, 'segment', Line((-25.12, -5.1, 0), (-25.6857, -4.53432, 0)), color=Color.from_hex("#aaaaaa"), width=0.042336)
add(1, 'segment', Line((-24.64, -5.1, 0), (-25.2057, -4.53432, 0)), color=Color.from_hex("#aaaaaa"), width=0.042336)
add(1, 'segment', Line((-24.16, -5.1, 0), (-24.7257, -4.53432, 0)), color=Color.from_hex("#aaaaaa"), width=0.042336)
add(1, 'segment', Line((-23.68, -5.1, 0), (-24.2457, -4.53432, 0)), color=Color.from_hex("#aaaaaa"), width=0.042336)
add(1, 'segment', Line((-23.2, -5.1, 0), (-23.7657, -4.53432, 0)), color=Color.from_hex("#aaaaaa"), width=0.042336)
add(1, 'label', Point(-24.4, -6.8, 0), color=Color.from_hex("#aaaaaa"), text='roller')
add(1, 'point', Point(-16.6028, -4.6, 0), color=Color.from_hex("#ffffff"), width=0.4144)
add(1, 'segment', Line((-17.3228, -5.1, 0), (-17.8885, -4.53432, 0)), color=Color.from_hex("#aaaaaa"), width=0.042336)
add(1, 'segment', Line((-16.8428, -5.1, 0), (-17.4085, -4.53432, 0)), color=Color.from_hex("#aaaaaa"), width=0.042336)
add(1, 'segment', Line((-16.3628, -5.1, 0), (-16.9285, -4.53432, 0)), color=Color.from_hex("#aaaaaa"), width=0.042336)
add(1, 'segment', Line((-15.8828, -5.1, 0), (-16.4485, -4.53432, 0)), color=Color.from_hex("#aaaaaa"), width=0.042336)
add(1, 'segment', Line((-15.4028, -5.1, 0), (-15.9685, -4.53432, 0)), color=Color.from_hex("#aaaaaa"), width=0.042336)
add(1, 'label', Point(-16.6028, -6.8, 0), color=Color.from_hex("#aaaaaa"), text='pin')

# step 2 — The five loads
add(2, 'arrow', Line((-22.6004, 0.0392, 0), (-22.6004, -1.9208, 0)), color=Color.from_hex("#3f9c20"), width=0.110477, head=(0.357235, 0.153216))
add(2, 'label', Point(-21.1004, -0.6808, 0), color=Color.from_hex("#3f9c20"), text='A1')
add(2, 'arrow', Line((-18.602, 0.0392, 0), (-18.602, -1.9208, 0)), color=Color.from_hex("#3f9c20"), width=0.110477, head=(0.357235, 0.153216))
add(2, 'label', Point(-17.102, -0.6808, 0), color=Color.from_hex("#3f9c20"), text='A2')
add(2, 'arrow', Line((-14.6032, 0.0392, 0), (-14.6032, -1.9208, 0)), color=Color.from_hex("#3f9c20"), width=0.110477, head=(0.357235, 0.153216))
add(2, 'label', Point(-13.1032, -0.6808, 0), color=Color.from_hex("#3f9c20"), text='A3')
add(2, 'arrow', Line((-10.6048, 0.0392, 0), (-10.6048, -1.9208, 0)), color=Color.from_hex("#3f9c20"), width=0.110477, head=(0.357235, 0.153216))
add(2, 'label', Point(-9.1048, -0.6808, 0), color=Color.from_hex("#3f9c20"), text='A4')
add(2, 'arrow', Line((-6.6056, 0.0392, 0), (-6.6056, -1.9208, 0)), color=Color.from_hex("#3f9c20"), width=0.110477, head=(0.357235, 0.153216))
add(2, 'label', Point(-5.1056, -0.6808, 0), color=Color.from_hex("#3f9c20"), text='A5')

# step 3 — And the roller pulls down
add(3, 'arrow', Line((-24.4, -7.6, 0), (-24.4, -9.4, 0)), color=Color.from_hex("#3f9c20"), width=0.153216, head=(0.528192, 0.204019))
add(3, 'label', Point(-27.3, -8.5, 0), color=Color.from_hex("#3f9c20"), text='64.11 ↓')
add(3, 'arrow', Line((-16.6028, -9.4, 0), (-16.6028, -7.6, 0)), color=Color.from_hex("#3f9c20"), width=0.153216, head=(0.528192, 0.204019))
add(3, 'label', Point(-13.5028, -8.5, 0), color=Color.from_hex("#3f9c20"), text='314.11')

# step 4 — The flow inside the beam
add(4, 'segment', Line((-24.6, -2.2008, 0), (-24.4, -2.2008, 0)), color=Color.from_hex("#1a1eb2"), width=0.127411)
add(4, 'segment', Line((-24.4, -2.2008, 0), (-22.6004, -2.50846, 0)), color=Color.from_hex("#1a1eb2"), width=0.127411)
add(4, 'segment', Line((-22.6004, -2.50846, 0), (-18.602, -3.72512, 0)), color=Color.from_hex("#1a1eb2"), width=0.127411)
add(4, 'segment', Line((-18.602, -3.72512, 0), (-16.6028, -4.6, 0)), color=Color.from_hex("#1a1eb2"), width=0.127411)
add(4, 'segment', Line((-16.6028, -4.6, 0), (-14.6032, -3.8002, 0)), color=Color.from_hex("#1a1eb2"), width=0.127411)
add(4, 'segment', Line((-14.6032, -3.8002, 0), (-10.6048, -2.734, 0)), color=Color.from_hex("#1a1eb2"), width=0.127411)
add(4, 'segment', Line((-10.6048, -2.734, 0), (-6.6056, -2.2008, 0)), color=Color.from_hex("#1a1eb2"), width=0.127411)
add(4, 'segment', Line((-6.6056, -2.2008, 0), (-4.6072, -2.2008, 0)), color=Color.from_hex("#1a1eb2"), width=0.127411)
add(4, 'segment', Line((-24.6, -2.2008, 0), (-4.6072, -2.2008, 0)), color=Color.from_hex("#ce4095"), width=0.127411)
add(4, 'label', Point(-12.2036, -5.8, 0), color=Color.from_hex("#ce4095"), text='tie along the TOP: 375.02 kN tension')
add(4, 'segment', Line((-22.6004, -2.2008, 0), (-22.6004, -2.50846, 0)), color=Color.from_hex("#1a1eb2"), width=0.06048)
add(4, 'segment', Line((-18.602, -2.2008, 0), (-18.602, -3.72512, 0)), color=Color.from_hex("#1a1eb2"), width=0.06048)
add(4, 'segment', Line((-14.6032, -2.2008, 0), (-14.6032, -3.8002, 0)), color=Color.from_hex("#1a1eb2"), width=0.06048)
add(4, 'segment', Line((-10.6048, -2.2008, 0), (-10.6048, -2.734, 0)), color=Color.from_hex("#1a1eb2"), width=0.06048)
add(4, 'segment', Line((-6.6056, -2.2008, 0), (-6.6056, -2.2008, 0)), color=Color.from_hex("#1a1eb2"), width=0.06048)
add(4, 'segment', Line((-3.6472, -4.6, 0), (-3.6472, -2.2008, 0)), color=Color.from_hex("#aaaaaa"), width=0.042336)
add(4, 'label', Point(-1.0472, -3.4004, 0), color=Color.from_hex("#aaaaaa"), text='z = 2.999 m')
