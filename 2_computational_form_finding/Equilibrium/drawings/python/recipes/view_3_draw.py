...
add(2, 'arrow', Line((48.2984, 20.9594, 0), (48.2984, 10.2927, 0)), color=Color.from_hex("#3f9c20"), width=0.2088, head=(0.648, 0.2448))
add(2, 'arrow', Line((48.2984, 10.2927, 0), (48.2984, -0.373933, 0)), color=Color.from_hex("#3f9c20"), width=0.2088, head=(0.648, 0.2448))
...
add(7, 'arrow', Line((45.0294, 20.9594, 0), (45.0294, -0.373933, 0)), color=Color.from_hex("#3f9c20"), width=0.288, dash=0.66, head=(0.936, 0.36))
...
add(14, 'arrow', Line((45.0243, -1.8383, 0), (33.0981, 8.82727, 0)), color=Color.from_hex("#3f9c20"), width=0.2088, head=(0.648, 0.2448))
add(14, 'arrow', Line((33.0979, 11.7559, 0), (45.0242, 22.4236, 0)), color=Color.from_hex("#3f9c20"), width=0.2088, head=(0.648, 0.2448))
