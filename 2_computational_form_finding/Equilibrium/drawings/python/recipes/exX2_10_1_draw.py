...
add(0, 'label', Point(15.5, 11.2, 0), text='Kräfteplan — force diagram, one closed polygon per node')
add(0, 'label', Point(15.5, 10, 0), text='1 drawing unit ≙ 13 kN   (the sheet says 1 cm ≙ 10 kN)')
...
add(3, 'arrow', Line((12.6538, -15.6381, 0), (15.3462, -15.6381, 0)), color=Color.from_hex("#3f9c20"), width=0.110477, head=(0.357235, 0.153216))
add(3, 'arrow', Line((15.3462, -15.6381, 0), (14, -17.1619, 0)), color=Color.from_hex("#3f9c20"), width=0.110477, head=(0.357235, 0.153216))
add(3, 'arrow', Line((14, -17.1619, 0), (12.6538, -15.6381, 0)), color=Color.from_hex("#3f9c20"), width=0.110477, head=(0.357235, 0.153216))
add(3, 'label', Point(14, -13.6381, 0), color=Color.from_hex("#aaaaaa"), text='global: Q_d + R(P1) + R(P7) closes')
...
add(4, 'label', Point(4.5, 6.39042, 0), text='P1: R(P1) + 3 + 1')
add(4, 'arrow', Line((5.13908, 2.03332, 0), (3.79292, 0.50958, 0)), color=Color.from_hex("#3f9c20"), width=0.110477, head=(0.357235, 0.153216))
add(4, 'arrow', Line((3.79292, 0.50958, 0), (5.20707, 4.69042, 0)), color=Color.from_hex("#ce4095"), width=0.110477, head=(0.357235, 0.153216))
add(4, 'arrow', Line((5.20707, 4.69042, 0), (5.13908, 2.03332, 0)), color=Color.from_hex("#1a1eb2"), width=0.110477, head=(0.357235, 0.153216))
add(4, 'arrow', Line((5.13908, 2.03332, 0), (5.13908, 2.03332, 0)), color=Color.from_hex("#aaaaaa"), width=0.110477, head=(0.357235, 0.153216))
add(4, 'arrow', Line((5.13908, 2.03332, 0), (5.13908, 2.03332, 0)), color=Color.from_hex("#aaaaaa"), width=0.110477, head=(0.357235, 0.153216))
add(4, 'label', Point(14, 6.39042, 0), text='P2: 1 + 4 + 2')
add(4, 'arrow', Line((11.9353, 0.50958, 0), (12.0033, 3.16668, 0)), color=Color.from_hex("#1a1eb2"), width=0.110477, head=(0.357235, 0.153216))
add(4, 'arrow', Line((12.0033, 3.16668, 0), (16.0647, 4.69042, 0)), color=Color.from_hex("#ce4095"), width=0.110477, head=(0.357235, 0.153216))
add(4, 'arrow', Line((16.0647, 4.69042, 0), (11.9353, 0.50958, 0)), color=Color.from_hex("#1a1eb2"), width=0.110477, head=(0.357235, 0.153216))
add(4, 'arrow', Line((11.9353, 0.50958, 0), (11.9353, 0.50958, 0)), color=Color.from_hex("#aaaaaa"), width=0.110477, head=(0.357235, 0.153216))
add(4, 'arrow', Line((11.9353, 0.50958, 0), (11.9353, 0.50958, 0)), color=Color.from_hex("#aaaaaa"), width=0.110477, head=(0.357235, 0.153216))
add(4, 'label', Point(23.5, 6.39042, 0), text='P3: 2 + 3 + 5')
add(4, 'arrow', Line((21.4353, 0.50958, 0), (25.5647, 4.69042, 0)), color=Color.from_hex("#1a1eb2"), width=0.110477, head=(0.357235, 0.153216))
add(4, 'arrow', Line((25.5647, 4.69042, 0), (24.1506, 0.50958, 0)), color=Color.from_hex("#ce4095"), width=0.110477, head=(0.357235, 0.153216))
add(4, 'arrow', Line((24.1506, 0.50958, 0), (21.4353, 0.50958, 0)), color=Color.from_hex("#1a1eb2"), width=0.110477, head=(0.357235, 0.153216))
add(4, 'arrow', Line((21.4353, 0.50958, 0), (21.4353, 0.50958, 0)), color=Color.from_hex("#aaaaaa"), width=0.110477, head=(0.357235, 0.153216))
add(4, 'arrow', Line((21.4353, 0.50958, 0), (21.4353, 0.50958, 0)), color=Color.from_hex("#aaaaaa"), width=0.110477, head=(0.357235, 0.153216))
...
add(5, 'label', Point(4.5, -4.43813, 0), text='P4: Q_d + 4 + 7 + 6 + 5')
add(5, 'arrow', Line((5.8692, -6.13813, 0), (8.56151, -6.13813, 0)), color=Color.from_hex("#3f9c20"), width=0.110477, head=(0.357235, 0.153216))
add(5, 'arrow', Line((8.56151, -6.13813, 0), (4.50007, -7.66187, 0)), color=Color.from_hex("#ce4095"), width=0.110477, head=(0.357235, 0.153216))
add(5, 'arrow', Line((4.50007, -7.66187, 0), (0.438488, -6.13813, 0)), color=Color.from_hex("#1a1eb2"), width=0.110477, head=(0.357235, 0.153216))
add(5, 'arrow', Line((0.438488, -6.13813, 0), (3.15392, -6.13813, 0)), color=Color.from_hex("#ce4095"), width=0.110477, head=(0.357235, 0.153216))
add(5, 'arrow', Line((3.15392, -6.13813, 0), (5.8692, -6.13813, 0)), color=Color.from_hex("#1a1eb2"), width=0.110477, head=(0.357235, 0.153216))
add(5, 'label', Point(14, -3.77712, 0), text='P5: 8 + 9 + 6')
add(5, 'arrow', Line((12.6423, -8.32287, 0), (15.226, -5.47713, 0)), color=Color.from_hex("#1a1eb2"), width=0.110477, head=(0.357235, 0.153216))
add(5, 'arrow', Line((15.226, -5.47713, 0), (15.3577, -8.32287, 0)), color=Color.from_hex("#ce4095"), width=0.110477, head=(0.357235, 0.153216))
add(5, 'arrow', Line((15.3577, -8.32287, 0), (12.6423, -8.32287, 0)), color=Color.from_hex("#ce4095"), width=0.110477, head=(0.357235, 0.153216))
add(5, 'arrow', Line((12.6423, -8.32287, 0), (12.6423, -8.32287, 0)), color=Color.from_hex("#aaaaaa"), width=0.110477, head=(0.357235, 0.153216))
add(5, 'arrow', Line((12.6423, -8.32287, 0), (12.6423, -8.32287, 0)), color=Color.from_hex("#aaaaaa"), width=0.110477, head=(0.357235, 0.153216))
add(5, 'label', Point(23.5, -3.01525, 0), text='P6: 10 + 8 + 7')
add(5, 'arrow', Line((25.5308, -9.08475, 0), (24.0529, -4.71525, 0)), color=Color.from_hex("#1a1eb2"), width=0.110477, head=(0.357235, 0.153216))
add(5, 'arrow', Line((24.0529, -4.71525, 0), (21.4692, -7.561, 0)), color=Color.from_hex("#1a1eb2"), width=0.110477, head=(0.357235, 0.153216))
add(5, 'arrow', Line((21.4692, -7.561, 0), (25.5308, -9.08475, 0)), color=Color.from_hex("#1a1eb2"), width=0.110477, head=(0.357235, 0.153216))
add(5, 'arrow', Line((25.5308, -9.08475, 0), (25.5308, -9.08475, 0)), color=Color.from_hex("#aaaaaa"), width=0.110477, head=(0.357235, 0.153216))
add(5, 'arrow', Line((25.5308, -9.08475, 0), (25.5308, -9.08475, 0)), color=Color.from_hex("#aaaaaa"), width=0.110477, head=(0.357235, 0.153216))
add(5, 'label', Point(4.5, -12.5153, 0), text='P7: R(P7) + 9 + 10')
add(5, 'arrow', Line((5.23895, -18.5847, 0), (3.8928, -17.061, 0)), color=Color.from_hex("#3f9c20"), width=0.110477, head=(0.357235, 0.153216))
add(5, 'arrow', Line((3.8928, -17.061, 0), (3.76105, -14.2153, 0)), color=Color.from_hex("#ce4095"), width=0.110477, head=(0.357235, 0.153216))
add(5, 'arrow', Line((3.76105, -14.2153, 0), (5.23895, -18.5847, 0)), color=Color.from_hex("#1a1eb2"), width=0.110477, head=(0.357235, 0.153216))
add(5, 'arrow', Line((5.23895, -18.5847, 0), (5.23895, -18.5847, 0)), color=Color.from_hex("#aaaaaa"), width=0.110477, head=(0.357235, 0.153216))
add(5, 'arrow', Line((5.23895, -18.5847, 0), (5.23895, -18.5847, 0)), color=Color.from_hex("#aaaaaa"), width=0.110477, head=(0.357235, 0.153216))
