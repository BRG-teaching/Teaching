...
add(1, 'label', Point(-25.6, -2.6, 0), text='A')
...
add(1, 'label', Point(-12.8032, 0.812, 0), text='B1')
add(1, 'point', Point(-19.2032, -5.4616, 0), color=Color.from_hex("#ffffff"), width=0.34928)
add(1, 'label', Point(-21.0032, -6.4616, 0), text='C')
...
add(1, 'label', Point(-22.2065, -2.98468, 0), color=Color.from_hex("#ce4095"), text='71.6')
add(1, 'label', Point(-13.9765, -2.08243, 0), color=Color.from_hex("#ce4095"), text='92.7')
add(1, 'point', Point(-14.4032, -3.9, 0), color=Color.from_hex("#ffffff"), width=0.4366)
add(1, 'label', Point(-12.8032, -4.1, 0), text='B2')
add(1, 'point', Point(-19.2032, -5.4616, 0), color=Color.from_hex("#ffffff"), width=0.34928)
add(1, 'label', Point(-21.0032, -6.4616, 0), text='C')
...
add(1, 'label', Point(-21.6489, -5.0616, 0), color=Color.from_hex("#ce4095"), text='135.2')
add(1, 'label', Point(-16.6415, -2.8071, 0), color=Color.from_hex("#ce4095"), text='109.6')
add(1, 'point', Point(-14.4032, -6.412, 0), color=Color.from_hex("#ffffff"), width=0.4366)
add(1, 'label', Point(-12.8032, -6.612, 0), text='B3')
add(1, 'point', Point(-19.2032, -5.4616, 0), color=Color.from_hex("#ffffff"), width=0.34928)
add(1, 'label', Point(-21.0032, -6.4616, 0), text='C')
...
add(1, 'label', Point(-19.5415, -2.61458, 0), color=Color.from_hex("#ce4095"), text='247.9')
add(1, 'label', Point(-15.6079, -4.2071, 0), color=Color.from_hex("#ce4095"), text='194.8')
add(1, 'arrow', Line((-18.6634, -2.0616, 0), (-18.6634, -4.6616, 0)), color=Color.from_hex("#3f9c20"), width=0.161424, head=(0.556488, 0.214949))
add(1, 'label', Point(-20.4032, -7.8616, 0), color=Color.from_hex("#3f9c20"), text='F₁ = 120 kN')
...
add(2, 'label', Point(-21.8, 3.4, 0), color=Color.from_hex("#e07a26"), text='statical depth d = 1.100 m')
...
add(3, 'label', Point(-24.5489, -4.69318, 0), color=Color.from_hex("#e07a26"), text='106.1')
add(3, 'label', Point(-14.7632, -5.6071, 0), color=Color.from_hex("#e07a26"), text='97.2')
...
add(3, 'label', Point(-11.1202, -0.588, 0), color=Color.from_hex("#3f9c20"), text='B = 97.2')
