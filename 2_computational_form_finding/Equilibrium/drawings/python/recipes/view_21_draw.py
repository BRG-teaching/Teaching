...
add(3, 'arrow', Line((48.2666, 11.6, 0), (48.2666, 8.6, 0)), color=Color.from_hex("#3f9c20"), width=0.1008, head=(0.54, 0.216))
...
add(3, 'arrow', Line((48.2666, 14.6, 0), (48.2666, 11.6, 0)), color=Color.from_hex("#3f9c20"), width=0.1008, head=(0.54, 0.216))
...
add(3, 'arrow', Line((48.2666, 17.6, 0), (48.2666, 14.6, 0)), color=Color.from_hex("#3f9c20"), width=0.1008, head=(0.54, 0.216))
...
add(11, 'arrow', Line((48.2666, 2.6, 0), (48.2666, -0.4, 0)), color=Color.from_hex("#3f9c20"), width=0.1008, head=(0.54, 0.216))
add(11, 'label', Point(46.25, 1.1, 0), color=Color.from_hex("#3f9c20"), text='F₄')
add(11, 'arrow', Line((48.2666, 5.6, 0), (48.2666, 2.6, 0)), color=Color.from_hex("#3f9c20"), width=0.1008, head=(0.54, 0.216))
add(11, 'label', Point(46.25, 4.1, 0), color=Color.from_hex("#3f9c20"), text='F₅')
add(11, 'arrow', Line((48.2666, 8.6, 0), (48.2666, 5.6, 0)), color=Color.from_hex("#3f9c20"), width=0.1008, head=(0.54, 0.216))
