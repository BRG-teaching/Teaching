...
add(3, 'segment', Line((-20.4, 4.5, 0), (-21, 5.3, 0)), color=Color.from_hex("#aaaaaa"), width=0.036288)
add(3, 'segment', Line((-19.7, 4.5, 0), (-20.3, 5.3, 0)), color=Color.from_hex("#aaaaaa"), width=0.036288)
add(3, 'segment', Line((-19, 4.5, 0), (-19.6, 5.3, 0)), color=Color.from_hex("#aaaaaa"), width=0.036288)
add(3, 'segment', Line((-18.3, 4.5, 0), (-18.9, 5.3, 0)), color=Color.from_hex("#aaaaaa"), width=0.036288)
add(3, 'segment', Line((-17.6, 4.5, 0), (-18.2, 5.3, 0)), color=Color.from_hex("#aaaaaa"), width=0.036288)
add(3, 'point', Point(19.34, -6.476, 0), color=Color.from_hex("#ffffff"), width=0.3552)
add(3, 'label', Point(21.14, -5.476, 0), text='B')
add(3, 'segment', Line((17.94, -5.976, 0), (17.34, -5.176, 0)), color=Color.from_hex("#aaaaaa"), width=0.036288)
add(3, 'segment', Line((18.64, -5.976, 0), (18.04, -5.176, 0)), color=Color.from_hex("#aaaaaa"), width=0.036288)
add(3, 'segment', Line((19.34, -5.976, 0), (18.74, -5.176, 0)), color=Color.from_hex("#aaaaaa"), width=0.036288)
add(3, 'segment', Line((20.04, -5.976, 0), (19.44, -5.176, 0)), color=Color.from_hex("#aaaaaa"), width=0.036288)
add(3, 'segment', Line((20.74, -5.976, 0), (20.14, -5.176, 0)), color=Color.from_hex("#aaaaaa"), width=0.036288)
