...
add(1, 'segment', Line((-20.14, -0.5, 0), (-20.8471, 0.207107, 0)), color=Color.from_hex("#aaaaaa"), width=0.033264)
add(1, 'segment', Line((-19.38, -0.5, 0), (-20.0871, 0.207107, 0)), color=Color.from_hex("#aaaaaa"), width=0.033264)
add(1, 'segment', Line((-18.62, -0.5, 0), (-19.3271, 0.207107, 0)), color=Color.from_hex("#aaaaaa"), width=0.033264)
add(1, 'segment', Line((-17.86, -0.5, 0), (-18.5671, 0.207107, 0)), color=Color.from_hex("#aaaaaa"), width=0.033264)
add(1, 'segment', Line((-17.1, -0.5, 0), (-17.8071, 0.207107, 0)), color=Color.from_hex("#aaaaaa"), width=0.033264)
add(1, 'point', Point(-5.7, 0, 0), color=Color.from_hex("#ffffff"), width=0.3256)
add(1, 'label', Point(-4.1, -1, 0), text='B')
add(1, 'segment', Line((-6.84, -0.5, 0), (-7.54711, 0.207107, 0)), color=Color.from_hex("#aaaaaa"), width=0.033264)
add(1, 'segment', Line((-6.08, -0.5, 0), (-6.78711, 0.207107, 0)), color=Color.from_hex("#aaaaaa"), width=0.033264)
add(1, 'segment', Line((-5.32, -0.5, 0), (-6.02711, 0.207107, 0)), color=Color.from_hex("#aaaaaa"), width=0.033264)
add(1, 'segment', Line((-4.56, -0.5, 0), (-5.26711, 0.207107, 0)), color=Color.from_hex("#aaaaaa"), width=0.033264)
add(1, 'segment', Line((-3.8, -0.5, 0), (-4.50711, 0.207107, 0)), color=Color.from_hex("#aaaaaa"), width=0.033264)
