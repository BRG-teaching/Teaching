...
add(1, 'segment', Line((-22.55, -2.92, 0), (-21.8782, -2.24825, 0)), color=Color.from_hex("#aaaaaa"), width=0.043092)
add(1, 'segment', Line((-22.55, -3.64, 0), (-21.8782, -2.96825, 0)), color=Color.from_hex("#aaaaaa"), width=0.043092)
add(1, 'segment', Line((-22.55, -4.36, 0), (-21.8782, -3.68825, 0)), color=Color.from_hex("#aaaaaa"), width=0.043092)
add(1, 'segment', Line((-22.55, -5.08, 0), (-21.8782, -4.40825, 0)), color=Color.from_hex("#aaaaaa"), width=0.043092)
add(1, 'segment', Line((-22.55, -5.8, 0), (-21.8782, -5.12825, 0)), color=Color.from_hex("#aaaaaa"), width=0.043092)
add(1, 'segment', Line((-22.55, 2.58, 0), (-21.8782, 3.25175, 0)), color=Color.from_hex("#aaaaaa"), width=0.043092)
add(1, 'segment', Line((-22.55, 1.86, 0), (-21.8782, 2.53175, 0)), color=Color.from_hex("#aaaaaa"), width=0.043092)
add(1, 'segment', Line((-22.55, 1.14, 0), (-21.8782, 1.81175, 0)), color=Color.from_hex("#aaaaaa"), width=0.043092)
add(1, 'segment', Line((-22.55, 0.42, 0), (-21.8782, 1.09175, 0)), color=Color.from_hex("#aaaaaa"), width=0.043092)
add(1, 'segment', Line((-22.55, -0.3, 0), (-21.8782, 0.371751, 0)), color=Color.from_hex("#aaaaaa"), width=0.043092)
...
add(2, 'arrow', Line((-26.1144, -6.05718, 0), (-22.9839, -4.49193, 0)), color=Color.from_hex("#3f9c20"), width=0.11245, head=(0.363614, 0.155952))
add(2, 'label', Point(-29.3566, -6.8783, 0), color=Color.from_hex("#3f9c20"), text='B0 = 100.6')
add(2, 'arrow', Line((-17.4, 2.02155, 0), (-20.9, 2.02155, 0)), color=Color.from_hex("#3f9c20"), width=0.11245, head=(0.363614, 0.155952))
...
# step 5 — Joint B3
add(5, 'label', Point(-8.25, -5.7, 0), color=Color.from_hex("#b9b9bd"), text='0')
add(5, 'label', Point(-7.2, -1.25, 0), color=Color.from_hex("#b9b9bd"), text='0')
...
# step 6 — Joint T0
add(6, 'label', Point(-19.25, 3.7985, 0), color=Color.from_hex("#ce4095"), text='90.0')
add(6, 'label', Point(-23.7, -1.25, 0), color=Color.from_hex("#b9b9bd"), text='0')
...
# step 7 — Joint T3
add(7, 'label', Point(-8.25, 3.29975, 0), color=Color.from_hex("#ce4095"), text='15.0')
add(7, 'label', Point(-6.94817, -2.55183, 0), color=Color.from_hex("#1a1eb2"), text='-21.2')
...
# step 8 — Joint B0
add(8, 'label', Point(-19.25, -5.99925, 0), color=Color.from_hex("#1a1eb2"), text='-45.0')
add(8, 'label', Point(-17.7487, -2.75133, 0), color=Color.from_hex("#1a1eb2"), text='-63.6')
...
# step 9 — Joint B2
add(9, 'label', Point(-13.75, -5.79975, 0), color=Color.from_hex("#1a1eb2"), text='-15.0')
add(9, 'label', Point(-12.7997, -1.25, 0), color=Color.from_hex("#ce4095"), text='15.0')
...
# step 10 — Joint T1
add(10, 'label', Point(-13.75, 3.49925, 0), color=Color.from_hex("#ce4095"), text='45.0')
add(10, 'label', Point(-18.3995, -1.25, 0), color=Color.from_hex("#ce4095"), text='30.0')
...
# step 11 — Joint T2
add(11, 'label', Point(-12.3484, -2.65158, 0), color=Color.from_hex("#1a1eb2"), text='-42.4')
