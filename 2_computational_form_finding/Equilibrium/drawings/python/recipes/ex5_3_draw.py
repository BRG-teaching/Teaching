...
add(1, 'segment', Line((-18.4, 0.5, 0), (-19, -0.3, 0)), color=Color.from_hex("#aaaaaa"), width=0.034776)
add(1, 'segment', Line((-17.7, 0.5, 0), (-18.3, -0.3, 0)), color=Color.from_hex("#aaaaaa"), width=0.034776)
add(1, 'segment', Line((-17, 0.5, 0), (-17.6, -0.3, 0)), color=Color.from_hex("#aaaaaa"), width=0.034776)
add(1, 'segment', Line((-16.3, 0.5, 0), (-16.9, -0.3, 0)), color=Color.from_hex("#aaaaaa"), width=0.034776)
add(1, 'segment', Line((-15.6, 0.5, 0), (-16.2, -0.3, 0)), color=Color.from_hex("#aaaaaa"), width=0.034776)
add(1, 'point', Point(-0.8, 1, 0), color=Color.from_hex("#ffffff"), width=0.3404)
add(1, 'label', Point(0.8, -0.2, 0), text='B')
add(1, 'segment', Line((-2.2, -0.5, 0), (-2.8, -1.3, 0)), color=Color.from_hex("#aaaaaa"), width=0.034776)
add(1, 'segment', Line((-1.5, -0.5, 0), (-2.1, -1.3, 0)), color=Color.from_hex("#aaaaaa"), width=0.034776)
add(1, 'segment', Line((-0.8, -0.5, 0), (-1.4, -1.3, 0)), color=Color.from_hex("#aaaaaa"), width=0.034776)
add(1, 'segment', Line((-0.1, -0.5, 0), (-0.7, -1.3, 0)), color=Color.from_hex("#aaaaaa"), width=0.034776)
add(1, 'segment', Line((0.6, -0.5, 0), (0, -1.3, 0)), color=Color.from_hex("#aaaaaa"), width=0.034776)
