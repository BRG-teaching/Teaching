...
function button1(){
ggbApplet.setValue("showN",1);
ggbApplet.setValue("showV",0);
ggbApplet.setValue("showM",0);
ggbApplet.setValue("showMParabola",0);
ggbApplet.setValue("showMThrustLine",0);
}

function button2(){
ggbApplet.setValue("showV",1);
ggbApplet.setValue("showN",0);
ggbApplet.setValue("showM",0);
ggbApplet.setValue("showMParabola",0);
ggbApplet.setValue("showMThrustLine",0);
}
...
function button3(){
ggbApplet.setValue("showM",1);
ggbApplet.setValue("showN",0);
ggbApplet.setValue("showV",0);

	if(ggbApplet.getValue("showM")==1){
		ggbApplet.setValue("showMParabola",0);
		ggbApplet.setValue("showMThrustLine",0);
	}
}
