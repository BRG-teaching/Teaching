...
| 55 | Three-hinged Braced Arch, 1903 (HISTORICAL: Sondericker Plate II) | hand-written ✔ (first non-applet view, reconstructed from the 1903 book scan + text: straight-30° outer chord 8.05+6×5, 30-ft inner arc + straight, vertical end post 5/6/8.05, tension-only counters selected live, three-hinge H/V vs book 14860/9900 (Δ<5%), c-8 vs 35250 (Δ2.9%), Maxwell diagram built joint-by-joint (closure ~1e-11), line of pressure + pole-check funicular, plate overlay toggle; regression tools/regress/v55_regress.py, decode notes/view_55_analysis.md) |
